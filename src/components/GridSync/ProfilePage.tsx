          ...
          <div className="border border-border rounded-lg bg-card">
            ...
            {showPrivacy && (
              <div className="px-5 pb-4 text-xs text-muted-foreground leading-relaxed space-y-3 border-t border-border pt-3">
                ...
                <p><strong className="text-foreground">Contact:</strong> For privacy-related inquiries, please contact us at support@syncronice.app.</p>
              </div>
            )}
          </div>
          ...
          <div className="border border-border rounded-lg bg-card">
            ...
            {showTerms && (
              <div className="px-5 pb-4 text-xs text-muted-foreground leading-relaxed space-y-3 border-t border-border pt-3">
                ...
                <p><strong className="text-foreground">Service Description:</strong> SyncroNice is a bulk product editing tool for Shopify merchants. It allows you to view, edit, and push product changes to your connected Shopify store(s).</p>
                ...
                <p><strong className="text-foreground">Limitation of Liability:</strong> SyncroNice is provided "as is" without warranties. We are not liable for any damages arising from your use of the service, including but not limited to data loss, incorrect product updates, or Shopify API errors. You are responsible for reviewing changes before applying them.</p>
                ...
                <p><strong className="text-foreground">Contact:</strong> For questions about these terms, contact us at support@syncronice.app.</p>
              </div>
            )}
          </div>
        </div>
